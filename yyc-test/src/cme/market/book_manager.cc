...
namespace market
{
    ...
    void BookManager::Set_definition_data(std::vector<fh::cme::market::message::MdpMessage> *definition_datas)
    {
        this->Parse_definition(*definition_datas);
    }

    // set received recovery messages
    void BookManager::Set_recovery_data(std::vector<fh::cme::market::message::MdpMessage> *recovery_datas)
    {
