...
namespace rczg
{
	...
	void BookStateController::Create_or_shrink(const rczg::Instrument &instrument)
	{
	...
	bool BookStateController::Modify_state(const Book &b)
	{
	...
	std::string BookStateController::Get()
	{
    	...
    	std::for_each(m_md_book_states.cbegin(), m_md_book_states.cend(), [&os](const std::pair<std::uint32_t , rczg::BookState> &bs)
    	{
	...
	bool BookStateController::Reset_state(const Book &b, BookState &book_state)
	{
		// TODO
	...
	bool BookStateController::Update_price(const Book &b, BookState &book_state)
	{
		if(b.type == 'W')
		{
	...
	bool BookStateController::New_price(const Book &b, BookState &book_state)
	{
	...
	bool BookStateController::Change_price(const Book &b, BookState &book_state)
	{
	...
	bool BookStateController::Delete_price(const Book &b, BookState &book_state)
	{
	...
	bool BookStateController::Delete_all_price(const Book &b, BookState &book_state)
	{
	...
	bool BookStateController::Delete_top_price(const Book &b, BookState &book_state)
	{
