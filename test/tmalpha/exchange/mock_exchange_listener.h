...
#ifndef __FH_TMALPHA_EXCHANGE_MOCK_EXCHANGE_LISTENER_H__
#define __FH_TMALPHA_EXCHANGE_MOCK_EXCHANGE_LISTENER_H__
...
namespace exchange
{
    ...
    class MockExchangeListener : public core::exchange::ExchangeListenerI
    {
        public:
            MockExchangeListener() : m_orders(), m_fills() {}
            virtual ~MockExchangeListener() {}
        ...
        private:
            DISALLOW_COPY_AND_ASSIGN(MockExchangeListener);
    };
}   // namespace exchange
}   // namespace tmalpha
}   // namespace fh

#endif  // __FH_TMALPHA_EXCHANGE_MOCK_EXCHANGE_LISTENER_H__
