#ifndef __FH_CME_EXCHANGE_MESSAGE_ORDERMASSSTATUSREQUEST_H__
#define __FH_CME_EXCHANGE_MESSAGE_ORDERMASSSTATUSREQUEST_H__
...
namespace message
{
  class OrderMassStatusRequest : public FIX42::Message
  {
  public:
