#ifndef __FH_CME_EXCHANGE_MESSAGE_ORDERMASSACTIONREPORT_H__
#define __FH_CME_EXCHANGE_MESSAGE_ORDERMASSACTIONREPORT_H__
...
namespace message
{
  ...
  class OrderMassActionReport : public FIX42::Message
  {
  public:
