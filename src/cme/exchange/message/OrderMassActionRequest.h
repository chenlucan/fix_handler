#ifndef __FH_CME_EXCHANGE_MESSAGE_ORDERMASSACTIONREQUEST_H__
#define __FH_CME_EXCHANGE_MESSAGE_ORDERMASSACTIONREQUEST_H__
...
namespace message
{
class OrderMassActionRequest : public FIX42::Message
  {
  public:
