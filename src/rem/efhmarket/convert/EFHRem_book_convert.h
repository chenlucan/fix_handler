#ifndef __FH_REM_EFHMARKET_CONVERT_EFHREM_BOOK_CONVERT_H__
#define __FH_REM_EFHMARKET_CONVERT_EFHREM_BOOK_CONVERT_H__
#include <string>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
inline std::string T(char *v){return std::string(v);}
    ...
    class EfhRemConvertListenerI : public fh::core::market::MarketListenerI 
    {
        public:
            EfhRemConvertListenerI();
            virtual ~EfhRemConvertListenerI();
        ...
        private:
            DISALLOW_COPY_AND_ASSIGN(EfhRemConvertListenerI);
    ...
    class EfhRemBookConvert
    {
	 ...
	 private:
	     EfhRemConvertListenerI* m_listener;	 
	     //fh::core::market::MarketListenerI *m_listener;
	     fh::rem::efhmarket::CRemEfhMarkrtManager *m_efhrem_book_manager;	
...
#endif // __FH_REM_EFHMARKET_CONVERT_EFHREM_BOOK_CONVERT_H__
