...
namespace market
{
    ...
    CRemBookSender::CRemBookSender(const std::string &org_url, const std::string &book_url)
    : m_org_sender(org_url), m_book_sender(book_url)
    {
        // noop
    }

    CRemBookSender::~CRemBookSender()
    {
        // noop
    }

    // implement of MarketListenerI
    void CRemBookSender::OnMarketDisconnect(core::market::MarketI* market)
    {
        // noop
    }

    // implement of MarketListenerI
    void CRemBookSender::OnMarketReconnect(core::market::MarketI* market)
    {
        // noop
    }

    // implement of MarketListenerI
    void CRemBookSender::OnContractDefinition(const pb::dms::Contract &contract)
    {
        //
    ...
    // implement of MarketListenerI
    void CRemBookSender::OnBBO(const pb::dms::BBO &bbo)
    {//测试发送数据
    ...
    // implement of MarketListenerI
    void CRemBookSender::OnBid(const pb::dms::Bid &bid)
    {//测试发送数据
    ...
    // implement of MarketListenerI
    void CRemBookSender::OnOffer(const pb::dms::Offer &offer)
    {//测试发送数据
    ...
    // implement of MarketListenerI
    void CRemBookSender::OnL2(const pb::dms::L2 &l2)
    {//测试发送数据
    ...
    // implement of MarketListenerI
    void CRemBookSender::OnL3()
    {
        // noop
    }

    // implement of MarketListenerI
    void CRemBookSender::OnTrade(const pb::dms::Trade &trade)
    {
        //
    ...
    // implement of MarketListenerI
    void CRemBookSender::OnContractAuctioning(const std::string &contract)
    {
        LOG_INFO("contract[", contract, "] status update [Auction]");
    }

    // implement of MarketListenerI
    void CRemBookSender::OnContractNoTrading(const std::string &contract)
    {
        LOG_INFO("contract[", contract, "] status update [NoTrading]");
    }

    // implement of MarketListenerI
    void CRemBookSender::OnContractTrading(const std::string &contract)
    {
		LOG_INFO("contract[", contract, "] status update [Trading]");
    }

    // implement of MarketListenerI
    void CRemBookSender::OnOrginalMessage(const std::string &message)
    {
