...
TEST_OBJS = $(BIN_PATH)/utility_unittest.o $(BIN_PATH)/mut_rem_book_manager.o $(BIN_PATH)/mut_rem_matket.o $(BIN_PATH)/mut_rem_market_manager.o $(BIN_PATH)/mut_rem_exchange.o
